...
class_name PostProcessSilhouetteLayered


var silhouette_viewport_texture : ViewportTexture
var obstruction_viewport_texture : ViewportTexture
...
func _initialize_compute() -> void:
	...
	# Compile our shader.
	var shader_file := load("res://addons/depth_buffer/post_process_silhouette_layered.glsl")
	...
	if rd and pipeline.is_valid():
		...
		if render_scene_buffers:
			...
			for view in view_count:
				...
				var vpt_rid := RenderingServer.texture_get_rd_texture(silhouette_viewport_texture.get_rid())
				...
				vpt_rid = RenderingServer.texture_get_rd_texture(obstruction_viewport_texture.get_rid())
